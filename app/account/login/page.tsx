...
export default async function LoginPage({ searchParams }: PageProps) {
  ...
  return (
    <section className="relative bg-cream-deep px-5 pt-16 pb-24 sm:px-8">
      <div className="mx-auto w-full max-w-md pt-6 text-center">
        <span className="mx-auto mb-6 grid size-16 place-items-center rounded-full bg-sage text-on-accent">
          <Icon name="shield" className="size-7" />
        </span>
        <h1 className="font-display text-[clamp(2rem,1.5rem+2vw,3rem)] leading-[1.05] font-extrabold tracking-[-0.04em] text-espresso">
          Sign in
        </h1>
        <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-espresso-soft">
        ...
        {!isCustomerAccountConfigured() ? (
          <div className="mt-8 rounded-card border border-sand bg-paper px-6 py-8 text-left shadow-sm">
        ...
        <div className="mt-8 flex gap-3 rounded-card border border-sand bg-paper p-4 text-left shadow-sm">
          <Icon name="shield" className="mt-0.5 size-5 shrink-0 text-espresso" />
        ...
        <p className="mt-8 text-center text-xs text-espresso-mute">
