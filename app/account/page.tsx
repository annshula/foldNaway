  ...
  return (
    <div className="min-w-0">
      ...
      <div className="mt-8 grid gap-4 sm:mt-10 sm:gap-6 md:grid-cols-2">
        {/* Profile */}
        <div className="min-w-0 rounded-card border border-sand bg-paper p-5 shadow-sm sm:p-6">
          <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-2">
            <h2 className="font-display text-base font-bold text-espresso uppercase">
              Profile
            </h2>
            <Link
              href="/account/profile"
              className="group/link flex shrink-0 items-center gap-1 text-[0.7rem] font-semibold tracking-[0.14em] text-espresso uppercase"
            >
              Edit
              <Icon
                name="arrow-right"
          ...
          <div className="mt-5 flex items-center gap-4 sm:mt-6">
            <span className="grid size-12 shrink-0 place-items-center rounded-full bg-cream-deep font-display text-xl font-bold text-espresso uppercase sm:size-14">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm wrap-break-word text-espresso-soft">
        ...
        <div className="min-w-0 rounded-card border border-sand bg-paper p-5 shadow-sm sm:p-6">
          ...
          <div className="mt-5 flex items-start gap-4 sm:mt-6">
            <span className="grid size-12 shrink-0 place-items-center rounded-full bg-cream-deep text-espresso sm:size-14">
            ...
            {defaultAddress ? (
              ...
              <p className="text-sm text-espresso-mute">
