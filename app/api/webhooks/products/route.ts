...
// merchant sharing the connected Shopify store, not just FoldNAway. Never seed
...
// this storefront. Defaults to "HIMVOLT" — the real Shopify `vendor` on this catalog's
// products (the store is shared; FoldNAway is the storefront brand, HIMVOLT
// is what the vendor field actually says). Changing one means changing both.
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Shopify, not that the product belongs to FoldNAway's catalog. Reject any
