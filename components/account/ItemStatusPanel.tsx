  ...
  return (
    <li>
      <button
        ...
        className="group relative w-full cursor-pointer touch-manipulation overflow-hidden rounded-card border border-sand bg-paper text-left shadow-sm transition-[border-color,box-shadow,transform] duration-500 ease-(--ease-out-expo) hover:border-espresso/40 hover:shadow-(--shadow-lift) focus-visible:border-espresso focus-visible:outline-none active:scale-[0.995] active:bg-cream-deep active:duration-100"
      >
        {face}
      </button>
        ...
        createPortal(
          <div className="fixed inset-0 z-85 flex items-end justify-center md:items-center md:p-6">
            ...
            <div
              ...
              aria-modal="true"
              aria-label={label}
              className="relative flex max-h-[88svh] w-full flex-col overflow-hidden rounded-t-[1.75rem] bg-paper pb-[env(safe-area-inset-bottom)] shadow-(--shadow-lift) md:max-h-[80vh] md:max-w-3xl md:rounded-card md:pb-0"
            >
              ...
              >
                <span
                  aria-hidden="true"
                  className="h-1 w-11 rounded-full bg-sand transition-colors duration-300 group-active/handle:bg-espresso/40"
                />
              </button>
              ...
              <button
                ...
                onClick={() => setOpen(false)}
                aria-label="Close"
                className="absolute top-4 right-4 z-10 hidden size-11 place-items-center rounded-full text-espresso-soft transition-colors duration-300 hover:bg-cream-deep hover:text-espresso md:grid"
              >
