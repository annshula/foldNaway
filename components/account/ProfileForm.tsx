...
const inputClass =
  "w-full rounded-full border border-sand bg-cream-deep px-4 py-3 text-sm text-espresso transition-colors duration-300 placeholder:text-espresso-mute hover:border-espresso/30 focus:border-espresso focus:outline-none";
...
export function ProfileForm({
  ...
  return (
    <form
      action={formAction}
      className="rounded-card border border-sand bg-paper p-6 shadow-sm"
    >
