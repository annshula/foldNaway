/**
 * Encrypted server-side cookies (AES-256-GCM) for the Shopify customer
 * session and the OAuth handshake state.
 */
...
export const SESSION_COOKIE = "_fna_session";
export const OAUTH_STATE_COOKIE = "_fna_oauth";
